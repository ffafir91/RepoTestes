...
namespace ProjetoPessoalTeste1.WaitHelpers
{
    /// <summary>
    ...
    /// </code>
    /// </example>
    public sealed class ExpectedConditionsActual
    {
        /// <summary>
        /// Prevents a default instance of the <see cref="ExpectedConditionsActual"/> class from being created.
        /// </summary>
        private ExpectedConditionsActual()
        {
        }
